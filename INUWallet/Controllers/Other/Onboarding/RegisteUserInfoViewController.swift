...
class RegisteUserInfoViewController: UIViewController {
    ...
    @IBAction func didTapButton(_ sender: Any) {
        DatabaseManager.shared.insertUserInfo(name: nameTextField.text!, studentID: studentIDTextField.text!, department: departmentTextField.text!, grade: gradeTextField.text!)
